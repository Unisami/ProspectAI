...
from utils.error_handling_enhanced import ErrorHandlingService
...
class WebDriverConfig:
    ...
    page_load_timeout: int = 8  # Reduced from 20 to 8 seconds
    implicit_wait: int = 3      # Reduced from 10 to 3 seconds  
    disable_images: bool = True  # Enable image blocking for faster loading
...
class WebDriverPool:
    ...
    def _create_chrome_options(self) -> Options:
        ...
        prefs = {
            "profile.managed_default_content_settings.images": 2 if self.config.disable_images else 1,
            "profile.managed_default_content_settings.javascript": 2 if self.config.disable_javascript else 1,
        ...
        # GPU and WebGL error suppression
